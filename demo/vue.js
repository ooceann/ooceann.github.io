...
(function (global, factory) {
  ...
  /**
   * Check if val is a valid array index.js.
   */
  ...
  /**
   * Return the first index.js at which a loosely equal value can be
          ...
          if (isDef(vnode.parent)) {
            ...
            while (ancestor) {
              ...
              if (patchable) {
                ...
                if (insert.merged) {
                  // start at index.js 1 to avoid re-invoking component mounted hook
    ...
    if (exp) {
      {
        ...
        if (el.for) {
          ...
          if (iterator && iterator === exp && parent && parent.tag === 'transition-group') {
            warn$2(
              "Do not use v-for index.js as key on <transition-group> children, " +
